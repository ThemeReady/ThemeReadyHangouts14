...
.method public static a(Ljava/io/InputStream;Ljava/lang/Integer;Ljava/lang/Integer;ZZZF)Logb;
    .locals 9
    ...
    .line 2140
    invoke-direct {v4, v3}, Logk;-><init>(Landroid/graphics/Picture;)V

    .line 330
    invoke-virtual {v4, p1, p2}, Logk;->a(Ljava/lang/Integer;Ljava/lang/Integer;)V

    .line 331
    const/4 v5, 0x0

    invoke-virtual {v4, v5}, Logk;->a(Z)V

    .line 332
    const/4 v5, 0x0

    invoke-virtual {v4, v5}, Logk;->b(Z)V

    .line 333
    invoke-virtual {v4, p6}, Logk;->a(F)V

    .line 338
    new-instance v5, Loge;

    invoke-direct {v5, p0}, Loge;-><init>(Ljava/io/InputStream;)V
    ...
    invoke-virtual {v5}, Loge;->a()Ljava/io/ByteArrayInputStream;
    ...
    .line 344
    iget-object v6, v6, Logg;->a:Ljava/util/HashMap;

    iput-object v6, v4, Logk;->a:Ljava/util/HashMap;
    ...
    iget-object v1, v4, Logk;->o:Landroid/graphics/RectF;

    invoke-direct {v0, v3, v1}, Logb;-><init>(Landroid/graphics/Picture;Landroid/graphics/RectF;)V

    .line 352
    iget-object v1, v4, Logk;->p:Landroid/graphics/RectF;
    ...
    invoke-virtual {v0, v1}, Logb;->a(Landroid/graphics/RectF;)V
    :try_end_0
    ...
    invoke-direct {v1, v0}, Lbc;-><init>(Ljava/lang/Throwable;)V

    throw v1
.end method

.method static a(Ljava/lang/String;)Logi;
    .locals 10
    ...
    invoke-direct {v0, v6, v4}, Logi;-><init>(Ljava/util/ArrayList;I)V
    ...
    invoke-direct {v0, v6, v3}, Logi;-><init>(Ljava/util/ArrayList;I)V
...
.method static a(Ljava/lang/String;Lorg/xml/sax/Attributes;)Logi;
    .locals 3
...
.method static b(Ljava/lang/String;)Landroid/graphics/Path;
    ...
    invoke-direct {v0, v1, v4}, Loga;-><init>(Ljava/lang/CharSequence;I)V

    .line 572
    invoke-virtual/range {v28 .. v28}, Loga;->a()V
    ...
    .line 586
    invoke-virtual/range {v28 .. v28}, Loga;->b()V
    ...
    .line 601
    :sswitch_0
    invoke-virtual/range {v28 .. v28}, Loga;->c()F
