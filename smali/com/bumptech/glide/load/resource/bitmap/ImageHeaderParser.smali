...
.method public constructor <init>(Ljava/io/InputStream;Laoq;)V
    .locals 1
    ...
    iput-object v0, p0, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;->c:Laoq;

    .line 98
    new-instance v0, Laum;

    invoke-direct {v0, p1}, Laum;-><init>(Ljava/io/InputStream;)V

    iput-object v0, p0, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;->d:Laul;

    .line 99
    return-void
.end method

.method public constructor <init>(Ljava/nio/ByteBuffer;Laoq;)V
    .locals 1
    ...
    invoke-direct {v0, p1}, Lauj;-><init>(Ljava/nio/ByteBuffer;)V
...
.method private static a(Lauk;)I
    .locals 10
    ...
    .line 286
    invoke-virtual {p0, v1}, Lauk;->b(I)S
    ...
    .line 299
    :goto_0
    invoke-virtual {p0, v0}, Lauk;->a(Ljava/nio/ByteOrder;)V

    .line 301
    const/16 v0, 0xa

    invoke-virtual {p0, v0}, Lauk;->a(I)I
    ...
    .line 307
    invoke-virtual {p0, v3}, Lauk;->b(I)S
    ...
    invoke-virtual {p0, v5}, Lauk;->b(I)S
    ...
    invoke-virtual {p0, v6}, Lauk;->a(I)I
...
.method private d()I
    ...
    .line 244
    :cond_0
    iget-object v1, p0, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;->d:Laul;

    invoke-interface {v1}, Laul;->b()S
    ...
    .line 267
    iget-object v3, p0, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;->d:Laul;

    int-to-long v4, v1

    invoke-interface {v3, v4, v5}, Laul;->a(J)J
...
.method public b()Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser$ImageType;
    ...
    .line 114
    iget-object v0, p0, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;->d:Laul;

    invoke-interface {v0}, Laul;->a()I
    ...
    invoke-interface {v0, v2, v3}, Laul;->a(J)J

    .line 127
    iget-object v0, p0, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;->d:Laul;

    invoke-interface {v0}, Laul;->c()I
    ...
    invoke-interface {v0, v6, v7}, Laul;->a(J)J
...
.method public c()I
    ...
    .line 191
    iget-object v0, p0, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;->c:Laoq;

    const-class v3, [B

    invoke-virtual {v0, v2, v3}, Laoq;->a(ILjava/lang/Class;)Ljava/lang/Object;
    ...
    invoke-interface {v3, v0, v2}, Laul;->a([BI)I
    ...
    :cond_4
    :goto_2
    iget-object v2, p0, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;->c:Laoq;

    const-class v3, [B

    invoke-virtual {v2, v0, v3}, Laoq;->a(Ljava/lang/Object;Ljava/lang/Class;)V
    ...
    invoke-direct {v1, v0, v2}, Lauk;-><init>([BI)V

    invoke-static {v1}, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;->a(Lauk;)I
    :try_end_1
