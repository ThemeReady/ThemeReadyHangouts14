...
# direct methods
.method private constructor <init>(Lhvu;)V
    .locals 1

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    invoke-interface {p1}, Lhvu;->a()Landroid/net/Uri;

    move-result-object v0

    iput-object v0, p0, Lhvy;->a:Landroid/net/Uri;

    invoke-interface {p1}, Lhvu;->f()Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Lhvu;

    invoke-static {v0}, Lhvy;->b(Lhvu;)Lhvx;

    move-result-object v0

    iput-object v0, p0, Lhvy;->b:Lhvx;

    return-void
.end method

.method public static a(Lhvu;)Lhvy;
    .locals 2
    ...
    invoke-direct {v0, p0}, Lhvy;-><init>(Lhvu;)V

    return-object v0
.end method

.method private static b(Lhvu;)Lhvx;
    .locals 6

    const/4 v2, 0x0

    invoke-interface {p0}, Lhvu;->b()[B

    move-result-object v0

    if-nez v0, :cond_0

    invoke-interface {p0}, Lhvu;->c()Ljava/util/Map;
    ...
    :goto_2
    invoke-interface {p0}, Lhvu;->a()Landroid/net/Uri;
    ...
    invoke-static {v0}, Lhag;->a([B)Lhag;

    move-result-object v0

    new-instance v1, Lhaf;

    invoke-direct {v1, v0, v3}, Lhaf;-><init>(Lhag;Ljava/util/List;)V

    invoke-static {v1}, Lacf;->a(Lhaf;)Lhvx;
    :try_end_1
...
.method public a()Landroid/net/Uri;
    ...
    iget-object v0, p0, Lhvy;->a:Landroid/net/Uri;
