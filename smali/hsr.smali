...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lhsr;->o:[Ljava/lang/String;
...
.method public constructor <init>(Landroid/content/Context;Lhsq;ZILandroid/os/Bundle;Landroid/os/Bundle;Ljava/lang/String;)V
    ...
    invoke-direct/range {p0 .. p7}, Lhsm;-><init>(Landroid/content/Context;Lhsq;ZILandroid/os/Bundle;Landroid/os/Bundle;Ljava/lang/String;)V
...
.method private e()Ljava/lang/String;
    ...
    sget-object v2, Lhsr;->o:[Ljava/lang/String;

    invoke-direct {p0}, Lhsr;->f()Ljava/lang/String;
...
.method private f()Ljava/lang/String;
    ...
    invoke-static {v0}, Lacf;->a(Z)V

    invoke-virtual {p0}, Lhsr;->a()Lcom/google/android/gms/common/data/DataHolder;

    move-result-object v0

    invoke-static {v0}, Lacf;->L(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {v2, v0}, Lhsp;-><init>(Lcom/google/android/gms/common/data/DataHolder;)V

    const/4 v0, 0x1

    :goto_0
    invoke-virtual {v2}, Lhsp;->c()Z
...
.method protected a(Lhsp;Lhsp;Landroid/database/Cursor;)Lhse;
    ...
    iget-object v1, p0, Lhsr;->i:Lhue;

    const-string v2, "people-map start"

    invoke-virtual {v1, v2}, Lhue;->a(Ljava/lang/String;)V

    invoke-static {p1, v4}, Lhsr;->a(Lhsp;Ljava/util/HashMap;)V
    ...
    invoke-direct {v9}, Lhug;-><init>()V

    new-instance v10, Lhtf;

    invoke-direct {v10}, Lhtf;-><init>()V

    new-instance v8, Ljava/util/HashMap;

    invoke-direct {v8}, Ljava/util/HashMap;-><init>()V

    invoke-virtual {p0, p2, v8}, Lhsr;->b(Lhsp;Ljava/util/HashMap;)V
    ...
    invoke-virtual {p0, p3, v9, v10, v8}, Lhsr;->a(Landroid/database/Cursor;Lhug;Lhtf;Ljava/util/HashMap;)I

    move-result v1

    iget-object v2, p0, Lhsr;->i:Lhue;
    ...
    invoke-static {v2, v0}, Lacf;->i(Ljava/lang/String;Ljava/lang/String;)V

    :cond_0
    iget-object v0, p0, Lhsr;->i:Lhue;
    ...
    invoke-virtual {p0, v2, v1}, Lhsr;->a(Ljava/lang/String;Ljava/lang/String;)I
    ...
    invoke-virtual {p1, v2}, Lhsp;->a(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v2

    invoke-virtual {v5, v1}, Lhtg;->a(I)V

    invoke-virtual {v7, v2}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    if-eqz v2, :cond_3

    invoke-virtual {v9, v2}, Lhug;->a(Ljava/lang/String;)I
    ...
    invoke-virtual {v10, v1}, Lhtf;->a(I)I
    ...
    invoke-virtual {v6, v1}, Lhtg;->a(I)V
    ...
    :cond_c
    invoke-virtual {v6, v9, v2}, Lhtg;->a(Lhug;Ljava/lang/String;)V
    ...
    invoke-virtual {v10, v1, v0}, Lhtf;->a(II)Ljava/lang/String;
    ...
    iget-object v3, p0, Lhsr;->a:Landroid/content/Context;
    ...
    iget-object v10, p0, Lhsr;->f:Landroid/os/Bundle;
...
.method protected c()Landroid/database/Cursor;
    ...
    invoke-direct {p0}, Lhsr;->e()Ljava/lang/String;
    ...
    sget-object v0, Lhsk;->a:Landroid/net/Uri;
    ...
    invoke-virtual {v3, v2}, Lhud;->b(Ljava/lang/String;)V
    ...
    iget-object v1, p0, Lhsr;->a:Landroid/content/Context;

    invoke-static {v3, v0, v1}, Lhsj;->a(Lhud;ZLandroid/content/Context;)V

    invoke-static {v3}, Lhsj;->a(Lhud;)V
