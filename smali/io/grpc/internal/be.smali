...
.method public constructor <init>(Loju;)V
    ...
    .prologue
    .line 50
    invoke-direct {p0}, Lio/grpc/internal/ck;-><init>()V
    ...
    .line 52
    iput-object p1, p0, Lio/grpc/internal/be;->c:Loju;
...
.method public a(Lio/grpc/internal/da;)V
    ...
    .line 59
    iget-object v0, p0, Lio/grpc/internal/be;->c:Loju;

    new-instance v1, Loit;

    invoke-direct {v1}, Loit;-><init>()V

    invoke-interface {p1, v0, v1}, Lio/grpc/internal/da;->b(Loju;Loit;)V
