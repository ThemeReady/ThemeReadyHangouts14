...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lgqu;->c:Ljava/lang/String;

    sget v0, Landroid/os/Build$VERSION;->SDK_INT:I

    const-string v0, "androidPackageName"

    sput-object v0, Lgqu;->d:Ljava/lang/String;
    ...
    sput-object v0, Lgqu;->e:Landroid/content/ComponentName;
    ...
    sput-object v0, Lgqu;->a:Landroid/content/ComponentName;

    return-void
.end method

.method static a(Landroid/content/Context;Landroid/content/ComponentName;Lgqx;)Ljava/lang/Object;
    .locals 5
    ...
    invoke-direct {v1}, Lgvx;-><init>()V

    invoke-static {p0}, Lgul;->a(Landroid/content/Context;)Lgul;

    move-result-object v2

    const-string v0, "GoogleAuthUtil"

    invoke-virtual {v2, p1, v1, v0}, Lgul;->a(Landroid/content/ComponentName;Landroid/content/ServiceConnection;Ljava/lang/String;)Z
    ...
    :try_start_0
    invoke-virtual {v1}, Lgvx;->a()Landroid/os/IBinder;

    move-result-object v0

    invoke-interface {p2, v0}, Lgqx;->a(Landroid/os/IBinder;)Ljava/lang/Object;
    :try_end_0
    ...
    invoke-virtual {v2, p1, v1, v3}, Lgul;->b(Landroid/content/ComponentName;Landroid/content/ServiceConnection;Ljava/lang/String;)V
...
.method public static a(Landroid/content/Context;Landroid/accounts/Account;Ljava/lang/String;Landroid/os/Bundle;)Ljava/lang/String;
    ...
    invoke-static {p0, p1, p2, p3}, Lgqu;->b(Landroid/content/Context;Landroid/accounts/Account;Ljava/lang/String;Landroid/os/Bundle;)Lcom/google/android/gms/auth/TokenData;
...
.method static a(Landroid/content/Context;)V
    ...
    invoke-static {v0}, Lgrw;->d(Landroid/content/Context;)V
    :try_end_0
    ...
    invoke-direct {v1, v2, v3, v0}, Lgqy;-><init>(ILjava/lang/String;Landroid/content/Intent;)V
    ...
    invoke-virtual {v0}, Lgrs;->getMessage()Ljava/lang/String;
...
.method public static b(Landroid/content/Context;Landroid/accounts/Account;Ljava/lang/String;Landroid/os/Bundle;)Lcom/google/android/gms/auth/TokenData;
    ...
    invoke-static {v0}, Lacf;->M(Ljava/lang/String;)V

    const-string v0, "Scope cannot be empty or null."

    invoke-static {p2, v0}, Lacf;->a(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/String;

    const-string v0, "Account cannot be null."

    invoke-static {p1, v0}, Lacf;->f(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    invoke-static {p0}, Lgqu;->a(Landroid/content/Context;)V
    ...
    sget-object v2, Lgqu;->d:Ljava/lang/String;
    ...
    invoke-direct {v1, p1, p2, v0}, Lgqv;-><init>(Landroid/accounts/Account;Ljava/lang/String;Landroid/os/Bundle;)V

    sget-object v0, Lgqu;->e:Landroid/content/ComponentName;

    invoke-static {p0, v0, v1}, Lgqu;->a(Landroid/content/Context;Landroid/content/ComponentName;Lgqx;)Ljava/lang/Object;
...
.method static d(Landroid/content/Context;Ljava/lang/String;)[Landroid/accounts/Account;
    ...
    .line 0
    invoke-virtual {v0, p0}, Lgrr;->b(Landroid/content/Context;)V
