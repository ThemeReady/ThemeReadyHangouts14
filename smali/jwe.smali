...
# direct methods
.method private constructor <init>(Landroid/app/Activity;Ljzp;)V
    .locals 1
    ...
    iput-object v0, p0, Ljwe;->f:Ljava/util/ArrayList;
...
.method public constructor <init>(Lrx;Ljzp;)V
    ...
    .prologue
    .line 91
    invoke-direct {p0, p1, p2}, Ljwe;-><init>(Landroid/app/Activity;Ljzp;)V

    .line 92
    iput-object p1, p0, Ljwe;->c:Lrx;
...
.method private a()Z
    ...
    .line 150
    iget-object v0, p0, Ljwe;->f:Ljava/util/ArrayList;
    ...
    invoke-static {v0}, Ljwc;->a(Landroid/app/Activity;)Z
    ...
    invoke-direct {p0, v0}, Ljwe;->a(Lrx;)Z
    ...
    invoke-direct {p0, v0}, Ljwe;->a(Landroid/app/Activity;)Z
...
.method private a(Landroid/app/Activity;)Z
    ...
    iget-object v1, p0, Ljwe;->d:Ljsb;

    if-eqz v1, :cond_1

    .line 212
    iget-object v0, p0, Ljwe;->d:Ljsb;

    iget-object v1, p0, Ljwe;->b:Lizy;
    ...
    .line 212
    :cond_0
    invoke-interface {v0}, Ljsb;->a()Landroid/content/Intent;
...
.method private a(Lrx;)Z
    .locals 3

    .prologue
    .line 178
    invoke-virtual {p1}, Lrx;->J_()Landroid/content/Intent;
    ...
    .line 185
    invoke-virtual {p1, v0}, Lrx;->a_(Landroid/content/Intent;)Z
    ...
    .line 186
    invoke-static {p1}, Ley;->a(Landroid/content/Context;)Ley;

    move-result-object v1

    .line 187
    invoke-virtual {p1, v1}, Lrx;->a(Ley;)V

    .line 191
    invoke-virtual {v1}, Ley;->a()I
    ...
    .line 192
    invoke-virtual {v1, v0}, Ley;->a(Landroid/content/Intent;)Ley;
    ...
    .line 198
    :try_start_0
    invoke-static {p1}, Lag;->a(Landroid/app/Activity;)V
    :try_end_0
    .catch Ljava/lang/IllegalStateException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-virtual {p1}, Lrx;->finish()V
