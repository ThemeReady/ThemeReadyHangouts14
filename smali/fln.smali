...
.method public constructor <init>(Lcom/google/android/apps/hangouts/realtimechat/wakelock/impl/DebugWakelocksActivity;Landroid/content/Context;)V
    ...
    .prologue
    .line 56
    iput-object p1, p0, Lfln;->a:Lcom/google/android/apps/hangouts/realtimechat/wakelock/impl/DebugWakelocksActivity;
    ...
    invoke-virtual {p0, v0}, Lfln;->setOrientation(I)V

    .line 58
    new-instance v0, Lflo;

    iget-object v1, p0, Lfln;->a:Lcom/google/android/apps/hangouts/realtimechat/wakelock/impl/DebugWakelocksActivity;

    invoke-direct {v0, v1}, Lflo;-><init>(Landroid/content/Context;)V

    invoke-virtual {p0, v0}, Lfln;->addView(Landroid/view/View;)V

    .line 63
    iget-object v0, p0, Lfln;->a:Lcom/google/android/apps/hangouts/realtimechat/wakelock/impl/DebugWakelocksActivity;
