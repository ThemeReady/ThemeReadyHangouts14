...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lgxv;->b:Landroid/content/Context;

    return-void
.end method

.method static declared-synchronized a(Landroid/content/Context;)Lgxv;
    .locals 2
    ...
    invoke-direct {v0, p0}, Lgxv;-><init>(Landroid/content/Context;)V
...
.method private b(Landroid/os/Bundle;)Landroid/app/PendingIntent;
    ...
    invoke-static {p1, v0}, Lgxv;->a(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v1, p0, Lgxv;->b:Landroid/content/Context;
    ...
    invoke-static {v0}, Lgxe;->b(Landroid/os/Bundle;)V
    ...
    :cond_2
    iget-object v0, p0, Lgxv;->b:Landroid/content/Context;
...
.method private b(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p1, p2}, Lgxv;->a(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v4, p0, Lgxv;->b:Landroid/content/Context;
    ...
    :goto_2
    invoke-static {v0}, Lgxv;->a(Ljava/lang/String;)Ljava/lang/String;
...
.method a(Landroid/os/Bundle;)Z
    ...
    invoke-direct {p0, p1, v0}, Lgxv;->b(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v7, p0, Lgxv;->b:Landroid/content/Context;
    ...
    .line 1000
    :goto_1
    invoke-direct {p0, p1}, Lgxv;->b(Landroid/os/Bundle;)Landroid/app/PendingIntent;

    move-result-object v7

    new-instance v8, Ldf;

    iget-object v9, p0, Lgxv;->b:Landroid/content/Context;

    invoke-direct {v8, v9}, Ldf;-><init>(Landroid/content/Context;)V

    const/4 v9, 0x1

    invoke-virtual {v8, v9}, Ldf;->e(Z)Ldf;

    move-result-object v8

    invoke-virtual {v8, v3}, Ldf;->a(I)Ldf;
    ...
    invoke-virtual {v3, v4}, Ldf;->a(Ljava/lang/CharSequence;)Ldf;
    ...
    invoke-virtual {v3, v5}, Ldf;->b(Ljava/lang/CharSequence;)Ldf;
    ...
    invoke-virtual {v3, v4}, Ldf;->e(I)Ldf;

    :cond_1
    if-eqz v0, :cond_2

    invoke-virtual {v3, v0}, Ldf;->a(Landroid/net/Uri;)Ldf;

    :cond_2
    if-eqz v7, :cond_3

    invoke-virtual {v3, v7}, Ldf;->a(Landroid/app/PendingIntent;)Ldf;

    :cond_3
    invoke-virtual {v3}, Ldf;->b()Landroid/app/Notification;
    ...
    iget-object v8, p0, Lgxv;->b:Landroid/content/Context;
    ...
    invoke-virtual {v0}, Lgxw;->getMessage()Ljava/lang/String;
