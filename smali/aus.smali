...
.method public static a(Laov;Landroid/graphics/Bitmap;I)Landroid/graphics/Bitmap;
    .locals 6
    ...
    .line 281
    invoke-interface {p0, v0, v3, v4}, Laov;->a(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
    ...
    .line 285
    invoke-static {p1, v0, v1}, Laus;->a(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;Landroid/graphics/Matrix;)V
...
.method public static a(Laov;Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
    ...
    invoke-interface {p0, p2, p3, v0}, Laov;->a(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;

    move-result-object v0

    .line 94
    invoke-static {p1, v0}, Laus;->a(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;)V

    .line 96
    invoke-static {p1, v0, v3}, Laus;->a(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;Landroid/graphics/Matrix;)V
...
.method public static a(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;)V
    ...
    invoke-static {p1, v0}, Laus;->a(Landroid/graphics/Bitmap;Z)V
...
.method private static a(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;Landroid/graphics/Matrix;)V
    ...
    .line 417
    sget-object v1, Laus;->b:Landroid/graphics/Paint;
...
.method public static b(Laov;Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
    ...
    .line 137
    invoke-interface {p0, v0, v2, v3}, Laov;->a(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
    ...
    .line 151
    invoke-static {p1, v0, v2}, Laus;->a(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;Landroid/graphics/Matrix;)V
...
.method public static c(Laov;Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
    ...
    :cond_0
    invoke-static {p0, p1, p2, p3}, Laus;->b(Laov;Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
...
.method public static d(Laov;Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
    ...
    invoke-interface {p0, v1, v1, v3}, Laov;->a(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
    ...
    invoke-static {v1, v3}, Laus;->a(Landroid/graphics/Bitmap;Z)V
    ...
    sget-object v4, Laus;->d:Landroid/graphics/Paint;
    ...
    .line 337
    invoke-interface {p0, v0}, Laov;->a(Landroid/graphics/Bitmap;)V
