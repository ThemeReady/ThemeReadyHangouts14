...
.method private constructor <init>()V
    ...
    invoke-direct {p0, v0}, Lfxu;-><init>(Z)V
...
.method private constructor <init>(Z)V
    ...
    iput-object v0, p0, Lfxu;->b:Ljava/util/List;
...
.method private static a(Landroid/content/Context;)Lfxu;
    .locals 7
    ...
    invoke-static {v0}, Lgjw;->k(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-direct {v3, v5}, Lfxu;-><init>(Z)V

    .line 495
    :try_start_0
    invoke-static {v0, v2}, Lfxu;->b(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)Landroid/database/Cursor;
    ...
    invoke-static {v1, v0}, Lfxv;->a(Landroid/database/Cursor;Z)Lfxv;
    ...
    .line 500
    invoke-direct {v3, v0}, Lfxu;->a(Lfxv;)V
    :try_end_0
...
.method public static a(Landroid/content/Context;Ljava/lang/String;)Lfxu;
    .locals 8
    ...
    sget-object v2, Lfks;->l:Ljava/lang/String;
    ...
    invoke-static {v4, v5, v6}, Lacf;->a(Landroid/content/Context;Ljava/lang/String;I)I

    move-result v4

    invoke-direct {v2, v1, v3, v4}, Lfxv;-><init>(Ljava/lang/String;Ljava/lang/String;I)V

    .line 1367
    invoke-direct {v0, v2}, Lfxu;->a(Lfxv;)V
    ...
    .line 349
    :cond_1
    invoke-static {p0, p1}, Lfxu;->b(Landroid/content/Context;Ljava/lang/String;)Lfxu;
    ...
    .line 354
    :cond_2
    invoke-static {p0}, Lfxu;->a(Landroid/content/Context;)Lfxu;
...
.method public static a(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 605
    :try_start_0
    invoke-static {p0, p1}, Lfxu;->b(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)Landroid/database/Cursor;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private a(Lfxv;)V
    ...
    .line 301
    iget-object v0, p0, Lfxu;->b:Ljava/util/List;
...
.method private static b(Landroid/content/Context;Ljava/lang/String;)Lfxu;
    .locals 8
    ...
    .line 386
    invoke-static {p0}, Lfwp;->b(Landroid/content/Context;)Z
    ...
    .line 394
    :goto_1
    new-instance v7, Lfxu;

    invoke-direct {v7}, Lfxu;-><init>()V
    ...
    .line 397
    sget-object v2, Lfxu;->a:[Ljava/lang/String;
    ...
    invoke-static {v6, v0}, Lfxv;->a(Landroid/database/Cursor;Z)Lfxv;
    ...
    .line 406
    invoke-direct {v7, v0}, Lfxu;->a(Lfxv;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public a(Landroid/content/Context;Lfxv;)V
    .locals 3
    ...
    .line 587
    iget-object v1, p0, Lfxu;->b:Ljava/util/List;
    ...
    .line 594
    invoke-virtual {p2, p1}, Lfxv;->a(Landroid/content/Context;)V
